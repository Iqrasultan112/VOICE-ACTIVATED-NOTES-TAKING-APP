...
def add_note():
    ...
    def save_note():
        ...
        # Add the note to the saved notes frame
        note_content = tk.Text(saved_notes_frame, width=40, height=10)
    ...
    def add_note_from_speech():
       # def speech_recognition_thread():
            ...
            try:
                content_speech = r.recognize_google(audio)#online 
                #content_speech = r.recognize_sphinx(audio)  # Using PocketSphinx for offline recognition
...
def open_note(title, content):
    ...
    def read_note(note_title):
        ...
        # #taking current tab title and content
        # current_tab = notebook.index(notebook.select())
        # note_title = notebook.tab(current_tab, "text")
        # #print(notes.get(note_title))
